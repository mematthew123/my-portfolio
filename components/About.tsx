    ...
    >
      ...
      <p className='mb-3'>
        ...
        <span className='font-medium'>
          experienced software developer with expertise in React, Next.js,
          TypeScript, PHP, Java, and Node.
        </span>
      ...
      <p>
        <span className='italic'>Problem-solving</span> is at the core of my
        passion for programming. Seeing a problem, breaking it down into
        manageable pieces, and then building a solution is what I love most
        about programming.
      </p>
      <p>
